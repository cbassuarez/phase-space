...
function MainLayout() {
  ...
  return (
    <div className="flex h-full w-full flex-col">
      {isMobile ? (
        <div className="mx-auto flex h-full w-full max-w-6xl flex-1 flex-col px-4 pb-4 pt-4">
        ...
        <div className="mx-auto flex h-full w-full max-w-6xl flex-1 items-stretch gap-4 px-4 pb-4 pt-4 md:pb-6 md:pt-6">
          <aside className="flex h-full w-full max-w-xs shrink-0">
            <ControlPanelDesktop />
          </aside>
