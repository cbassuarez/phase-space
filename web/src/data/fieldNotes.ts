...
export const fieldNotes: FieldNote[] = [
  {
    ...
    body:
      "When ρ increases beyond the classic 28, the two lobes of the Lorenz attractor stretch and blur. The trajectories still hop back and forth, but the 'butterfly' begins to feel more like a cloud. This is a nice region for slow orbit or path rider modes: the global shape remains familiar, but local detail becomes more surprising.",
