...
export const systems: SystemMeta[] = [
  {
    ...
    heroImage: "/images/lorenz-hero.png", // TODO: replace or leave undefined
    parameterSummary: [
      {
        name: "σ (sigma)",
        range: "≈ 10",
  ...
  },
  {
    ...
    heroImage: "/images/rossler-hero.png",
    parameterSummary: [
      {
        name: "a",
        range: "≈ 0.2",
  ...
  },
  {
    ...
    heroImage: "/images/aizawa-hero.png",
    parameterSummary: [
  ...
  },
  {
    ...
    heroImage: "/images/thomas-hero.png",
    parameterSummary: [
      {
        name: "b",
        range: "≈ 0.208",
